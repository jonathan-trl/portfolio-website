...
export const careerExperiencesItems: CareerExperienceItem[] = [
  {
    ...
    responsibilities: [
      ...
      },
      {
        id: 2,
        description:
          'Desenvolvimento e manutenção de aplicações web utilizando PHP e CakePHP, garantindo funcionalidades robustas e escaláveis.',
      },
      {
        id: 3,
        description:
          'Construção de sistemas web dinâmicos e interativos, aproveitando as capacidades do PHP e do framework CakePHP para entrega de projetos de alta qualidade.',
      },
      {
        id: 4,
        description:
          'Experiência sólida em desenvolvimento full-stack, combinando habilidades em PHP, CakePHP e outras tecnologias front-end para criar aplicações web eficientes e modernas.',
      },
    ],
  },
  {
    ...
    responsibilities: [
      ...
      },
      {
        id: 3,
        description:
          'Desenvolvimento de componentes dinâmicos e interativos com Vue.js, aproveitando as capacidades do framework para construir aplicações web modernas e eficientes.',
      },
      {
        id: 4,
        description:
          'Implementação de designs responsivos e compatíveis com diversos dispositivos, combinando habilidades em HTML, CSS e JavaScript para garantir uma experiência consistente em todas as plataformas.',
      },
    ],
  },
  {
    ...
    responsibilities: [
      ...
      },
      {
        id: 2,
        description:
          'Implementação de soluções WordPress escaláveis e seguras, garantindo desempenho otimizado e manutenção eficiente dos sites.',
      },
      {
        id: 3,
        description:
          'Integração de funcionalidades avançadas e personalizadas, como comércio eletrônico, sistemas de gerenciamento de conteúdo e integração de APIs, para atender às demandas dos clientes.',
      },
    ],
  },

  {
    ...
    responsibilities: [
      ...
      },
      {
        id: 4,
        description:
          'Colaboração em equipes ágeis para criar e manter componentes front-end reutilizáveis, promovendo a eficiência e a consistência no desenvolvimento de software.',
      },
    ],
  },
  {
